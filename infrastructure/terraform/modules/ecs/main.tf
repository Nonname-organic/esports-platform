locals {
  ...
  # Convert app_env map to ECS environment array format
  env_vars = [for k, v in var.app_env : { name = k, value = v }]
}
...
resource "aws_ecs_service" "api" {
  ...
  lifecycle {
    # Allow GitHub Actions to update task_definition without Terraform reverting it
