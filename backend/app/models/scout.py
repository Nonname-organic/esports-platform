...
class ScoutProfile(UUIDMixin, Base):
    ...
    active_hours: Mapped[Optional[str]] = mapped_column(String(20), nullable=True)
    team_min_age: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    team_max_age: Mapped[Optional[int]] = mapped_column(Integer, nullable=True)
    premier_active: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
